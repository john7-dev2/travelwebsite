...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="destinations" className="py-16 sm:py-24 lg:py-32 bg-background relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-primary/10 blob" />
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-secondary/10 blob" style={{ animationDelay: "3s" }} />
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start mb-20">
            <div className="lg:w-1/3 animate-fade-in">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border-2 border-primary/30 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold text-primary">Top Picks</span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
              ...
              <Link to="/destinations">
                <Button
                  size="lg"
                  className="group bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white font-bold rounded-full px-8 shadow-lg"
                >
      ...
      <section id="experiences" className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-muted/50 via-background to-muted/30" />
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-secondary/10 border-2 border-secondary/30 rounded-full mb-6">
              <Compass className="w-4 h-4 text-secondary" />
              <span className="text-sm font-semibold text-secondary">Curated Adventures</span>
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold mb-6 leading-tight">
      ...
      <section id="testimonials" className="py-16 sm:py-24 lg:py-32 relative overflow-hidden bg-foreground/5">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-accent/10 blob rotate-slow" />
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent/10 border-2 border-accent/30 rounded-full mb-6">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="animate-slide-in-left space-y-8">
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
                  ...
                  <span className="block text-gradient text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">Adventure</span>
              ...
              <div className="animate-slide-in-right space-y-6">
                <Link to="/booking" className="block">
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-r from-primary via-secondary to-accent hover:opacity-90 text-white text-lg sm:text-xl py-6 sm:py-8 rounded-2xl font-bold shadow-2xl group"
                  >
                    Start Planning Now
                ...
                <Link to="/contact" className="block">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full text-lg sm:text-xl py-6 sm:py-8 rounded-2xl border-2 hover:bg-muted font-bold"
                  >
                    Talk to an Expert
                  </Button>
                </Link>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-4 pt-8">
                  <div className="text-center p-2 sm:p-4 bg-card rounded-xl sm:rounded-2xl border-2 border-border">
                    <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gradient">24/7</div>
                    <div className="text-xs sm:text-sm text-muted-foreground mt-1">Support</div>
                  </div>
                  <div className="text-center p-2 sm:p-4 bg-card rounded-xl sm:rounded-2xl border-2 border-border">
                    <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gradient">100%</div>
                    <div className="text-xs sm:text-sm text-muted-foreground mt-1">Secure</div>
                  </div>
                  <div className="text-center p-2 sm:p-4 bg-card rounded-xl sm:rounded-2xl border-2 border-border">
                    <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gradient">Free</div>
                    <div className="text-xs sm:text-sm text-muted-foreground mt-1 leading-tight">Cancellation</div>
                  </div>
                </div>
              </div>
            </div>
